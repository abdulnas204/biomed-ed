...
//Header functions
	...
	//Forward to editor
		if (isset ($_GET['id']) && $_GET['action'] == "edit") {
			...
			$moduleData = query("SELECT * FROM `moduledata` WHERE `id` = '{$_GET['id']}'");
...
//Title
	...
	$moduleDataGrabber = mysql_query("SELECT * FROM `moduledata`{$additionalSQL} ORDER BY `id` ASC", $connDBA);
	$moduleNumberGrabber = mysql_query("SELECT * FROM `moduledata`{$additionalSQL} ORDER BY `id` ASC", $connDBA);
