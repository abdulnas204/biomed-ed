...
//Grab the sidebar
	$sideBarCheck = mysql_query("SELECT * FROM sidebar", $connDBA);
	if (mysql_fetch_array($sideBarCheck)) {
		$sideBarDataGrabber = mysql_query("SELECT * FROM sidebar", $connDBA);
		$sideBarArray = array();
...
//Display content based on login status
	...
	//The admin toolbox div
		echo "<form name=\"pages\" action=\"site_administrator/cms/index.php\"><div style=\"width:100%\"><div align=\"center\"><div align=\"center\" class=\"toolBar\"><div align=\"center\"><a href=\"site_administrator/cms/manage_page.php?id=" . $pageInfo['id'] . "\">Edit This Page</a>  | Visible: <input type=\"hidden\" name =\"redirect\" value=\"home\" /><input type=\"hidden\" name =\"action\" value=\"modifySettings\" /><input type=\"hidden\" name =\"id\" value=\"" .  $pageInfo['id'] . "\" /><input type=\"hidden\" name =\"currentPosition\" value=\"" .  $pageInfo['position'] . "\" /><select name=\"visible\" onchange=\"this.form.submit();\"><option value=\"1\""; 
...
//Display the sidebar
	if (isset($sideBarResult)) {
		echo "</div><div class=\"dataRight\"><br /><br /><br />";
		
		$sideBarCheck = mysql_query("SELECT * FROM sidebar ORDER BY position ASC", $connDBA);
		while ($sideBar = mysql_fetch_array($sideBarCheck)) {
			switch ($sideBar['type']) {
			//If this is a custom content box
				case "Custom Content" : 
					echo "<div class=\"block_course_list sideblock\"><div class=\"header\"><div class=\"title\"><h2>" . $sideBar['title'] . "</h2></div></div><div class=\"content\">" . $sideBar['content'] . "</div></div>"; break;
			//If this is a login box	
				case "Login" : 
					if (!isset($_SESSION['MM_Username'])) {
						echo "<div class=\"block_course_list sideblock\"><div class=\"header\"><div class=\"title\"><h2>Login</h2></div></div><div class=\"content\"><form id=\"login\" name=\"login\" method=\"post\" action=\"index.php\"><div align=\"center\"><div style=\"width:75%;\"><p>User name: <input type=\"text\" name=\"username\" id=\"username\" autocomplete=\"off\" /><br />Password: <input type=\"password\" name=\"password\" id=\"password\" autocomplete=\"off\" /></p><p><input type=\"submit\" name=\"submit\" id=\"submit\" value=\"Login\" /></p></div></div></form></div></div>";	
					} break;
			//If this is a registration box
				case "Register" : 
					if (!isset($_SESSION['MM_Username'])) {
						echo "<div class=\"block_course_list sideblock\"><div class=\"header\"><div class=\"title\"><h2>Register</h2></div></div><div class=\"content\">" . $sideBar['content'] . "<div align=\"center\"><input type=\"button\" name=\"register\" id=\"register\" value=\"Register\" onclick=\"MM_goToURL('parent','register.php');return document.MM_returnValue\" /></div><p>&nbsp;</p></div></div>";
					} break;
			}
		}
