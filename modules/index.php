...
//Display the directions and tool bar for those with editing capabilities
	  if (isset($_SESSION['MM_UserGroup']) && $_SESSION['MM_UserGroup'] == "Site Administrator") {
		  echo "<h2>Modules</h2><p>Modifing the table below will chage the default settings and appearance for instructors.</p><p>&nbsp;</p><div class=\"toolBar\"><a href=\"../site_administrator/modules/index.php\"><img src=\"../images/common/back.png\" alt=\"Back\" width=\"24\" height=\"24\" /></a> <a href=\"../site_administrator/modules/index.php\">Back to Module Administration</a></div><br />";
	  }
...
//Display all modules			  
	  if ($modules == "exist") {
		  echo "<div align=\"center\">";
			  ...
			  echo "<tbody>";
				  echo "<tr>";
					  ...
					  echo "<th class=\"tableHeader\"><strong>Directions</strong></th>";
				  echo "</tr>";
			  //Select data for the loop
				  ...
				  while ($moduleData = mysql_fetch_array($moduleDataGrabber)){
					  ...
					  ">";									
						  echo "<td width=\"200\"><div align=\"center\"><a href=\"lesson.php?id=" . $moduleData['id'] . "\" onmouseover=\"Tip('Launch the <strong> " . $moduleData['name'] . " </strong>module.')\" onmouseout=\"UnTip()\">" . $moduleData['name'] . "</a></div></td>";
		  ...
		  echo "</table></div>";
			...
			echo "<br /></br /><div align=\"center\">There are no modules currently avaliable.</div><br /></br /><br /></br /><br /></br />";
	  }
?>
