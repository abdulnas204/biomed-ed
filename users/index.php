...
//Header functions
	...
	headers("Users", "Site Administrator", false, true); 
	
//Delete a user
	delete("users", "index.php");
	
//Title
	title("Users", "Below is a list of all users registered within this system. Users may be sorted according to a certain criteria by clicking on the text in the header row of the desired column.");
?>
