...
//Header functions
	...
	headers("Site Administration", "Site Administrator");
	
//Title
	title("Site Administration", "Welcome to the administration home page. This page contains a quick reference to major information about this site. Major parts of this site can be administered by navigating the links above.");
