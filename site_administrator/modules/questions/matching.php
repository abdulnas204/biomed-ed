...
//Matching form
	...
	echo "<table class=\"dataTable\" id=\"items\"><tr><th class=\"tableHeader\">Left-Column Values</th><th class=\"tableHeader\">Right-Column Values</th><th class=\"tableHeader\" width=\"50\"></th></tr>";
	...
	if (isset($questionData)) {
		...
		for ($count = 0; $count <= sizeof($questions) - 1; $count ++) {
			...
			echo "</td><td>";
			textField("answerValue[]", "answerValue" . $count, false, false, false, true, false, $answers[$count]);
