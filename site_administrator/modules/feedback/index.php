...
//Delete a feedback question
    ...
    if (isset ($_GET['question']) && isset ($_GET['id']) && $questionCheck == "1") {
		...
		switch ($questionPositionFetch['type']) {
			...
			case "Written Response" : $type = "truefalse"; break;
		}
				...
				while ($feedBackData = mysql_fetch_array($feedBackDataGrabber)) {					
					...
					">";
						...
						echo "<td width=\"100\"><div align=\"center\"><div>";
								...
								echo "</select>";
							echo "</div></div></td>";
						echo "<td width=\"150\"><div align=\"center\"><a href=\"javascript:void\" onclick=\"MM_openBrWindow('preview_question.php?id=" . $feedBackData['id'] . "','','status=yes,scrollbars=yes,resizable=yes,width=640,height=480')\" onmouseover=\"Tip('Preview this <strong>" . $feedBackData['type'] . "</strong> question')\" onmouseout=\"UnTip()\">" . $feedBackData['type'] . "</a></div></td>";
