	...
	//If the page is inserting an item		
		...
		//Get form data values			
			...
			$insertChoiceQuery = "INSERT INTO moduletest_{$currentTable} (
							...
							NULL, '0', '0', '{$lastQuestion}', 'True False', '{$points}', '{$extraCredit}', '', '{$difficulty}', '{$category}', '{$link}', '{$randomize}', '0', '', '1', '{$tags}', '{$question}', '', '{$answer}', '', '', '{$feedBackCorrect}', '{$feedBackIncorrect}', ''
							)";
...
<head>
<?php title("Module Setup Wizard : True or False"); ?>
<?php headers(); ?>
<?php tinyMCESimple(); ?>
<?php validate(); ?>
...
<?php topPage("site_administrator/includes/top_menu.php"); ?>
    <h2>Module Setup Wizard : True or False</h2>
