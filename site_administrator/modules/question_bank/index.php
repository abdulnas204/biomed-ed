...
//If an inserted alert is shown
  if (isset ($_GET['inserted'])) {
	  ...
	  echo "</strong> question was successfully inserted</div></div>";
//If an updated alert is shown
	  ...
	  echo "</strong> question was successfully updated</div></div>";
//If an deleted alert is shown  
	  ...
	  echo "</strong> question was successfully deleted</div></div>";
  } else {
	  echo "&nbsp;";
  }
?>
		...
		if (isset ($_GET['category'])) {
			...
			//Loop through the items
				...
				while ($testData = mysql_fetch_array($testImport)) {
					...
					echo "?id=" .  $testData['id'] . "\">" . "<img src=\"../../../images/admin_icons/edit.png\" alt=\"Edit\" onmouseover=\"Tip('Edit this <strong>" . $testData['type'] . "</strong> question')\" onmouseout=\"UnTip()\">" . "</a>" . "</div></td><td width=\"50\"><div align=\"center\">" . "<a href=\"index.php?id=" .  $testData['id'] . "&action=delete\" onclick=\"return confirm ('This action will delete this question from the question bank, and from any of the tests it is currently linked. Continue?');\">" . "<img src=\"../../../images/admin_icons/delete.png\" alt=\"Delete\" onmouseover=\"Tip('Delete this <strong>" . $testData['type'] . "</strong> question')\" onmouseout=\"UnTip()\">" . "</a></div></td></tr>";
				}
